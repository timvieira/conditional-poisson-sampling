...
<script>
(function() {
var raw = [[["DP forward", "Z", 50, 5, 0.1149], ["NumPy tree", "Z", 50, 5, 5.6288], ["PyTorch FFT", "Z", 50, 5, 1.8605], ["Fwd-bwd DP", "pi", 50, 5, 2.3067], ["NumPy tree", "pi", 50, 5, 5.856], ["PyTorch FFT + autograd", "pi", 50, 5, 5.5034], ["N\u00d7DP loo", "pi", 50, 5, 6.4967], ["N\u00d7Tree loo", "pi", 50, 5, 299.8758], ["R:sampling (pi)", "pi", 50, 5, 0.2974], ["R:sampling (1 sample)", "samples", 50, 5, 2.0], ["NumPy tree (1 sample)", "samples", 50, 5, 0.9507], ["DP forward", "Z", 50, 10, 0.2331], ["NumPy tree", "Z", 50, 10, 6.2662], ["PyTorch FFT", "Z", 50, 10, 1.5024], ["Fwd-bwd DP", "pi", 50, 10, 3.3746], ["NumPy tree", "pi", 50, 10, 6.1098], ["PyTorch FFT + autograd", "pi", 50, 10, 4.6587], ["N\u00d7DP loo", "pi", 50, 10, 11.5181], ["N\u00d7Tree loo", "pi", 50, 10, 326.6101], ["R:sampling (pi)", "pi", 50, 10, 0.4714], ["R:sampling (1 sample)", "samples", 50, 10, 3.0], ["NumPy tree (1 sample)", "samples", 50, 10, 1.8767], ["DP forward", "Z", 50, 20, 0.3836], ["NumPy tree", "Z", 50, 20, 6.1981], ["PyTorch FFT", "Z", 50, 20, 1.4298], ["Fwd-bwd DP", "pi", 50, 20, 4.755], ["NumPy tree", "pi", 50, 20, 6.3845], ["PyTorch FFT + autograd", "pi", 50, 20, 4.5879], ["N\u00d7DP loo", "pi", 50, 20, 21.6196], ["N\u00d7Tree loo", "pi", 50, 20, 334.5501], ["R:sampling (pi)", "pi", 50, 20, 1.0], ["R:sampling (1 sample)", "samples", 50, 20, 4.0], ["NumPy tree (1 sample)", "samples", 50, 20, 3.0804], ["DP forward", "Z", 100, 5, 0.2549], ["NumPy tree", "Z", 100, 5, 13.5154], ["PyTorch FFT", "Z", 100, 5, 2.6977], ["Fwd-bwd DP", "pi", 100, 5, 4.9875], ["NumPy tree", "pi", 100, 5, 13.1486], ["PyTorch FFT + autograd", "pi", 100, 5, 6.4668], ["N\u00d7DP loo", "pi", 100, 5, 26.3615], ["N\u00d7Tree loo", "pi", 100, 5, 1267.6371], ["R:sampling (pi)", "pi", 100, 5, 1.0], ["R:sampling (1 sample)", "samples", 100, 5, 5.0], ["NumPy tree (1 sample)", "samples", 100, 5, 1.2782], ["DP forward", "Z", 100, 10, 0.472], ["NumPy tree", "Z", 100, 10, 12.6594], ["PyTorch FFT", "Z", 100, 10, 2.0622], ["Fwd-bwd DP", "pi", 100, 10, 7.5971], ["NumPy tree", "pi", 100, 10, 12.9007], ["PyTorch FFT + autograd", "pi", 100, 10, 7.488], ["N\u00d7DP loo", "pi", 100, 10, 49.0697], ["N\u00d7Tree loo", "pi", 100, 10, 1278.467], ["R:sampling (pi)", "pi", 100, 10, 1.0], ["R:sampling (1 sample)", "samples", 100, 10, 6.0], ["NumPy tree (1 sample)", "samples", 100, 10, 2.6392], ["DP forward", "Z", 100, 20, 0.9222], ["NumPy tree", "Z", 100, 20, 13.3374], ["PyTorch FFT", "Z", 100, 20, 2.234], ["Fwd-bwd DP", "pi", 100, 20, 11.5363], ["NumPy tree", "pi", 100, 20, 14.5065], ["PyTorch FFT + autograd", "pi", 100, 20, 6.8087], ["N\u00d7DP loo", "pi", 100, 20, 92.9974], ["N\u00d7Tree loo", "pi", 100, 20, 1455.7877], ["R:sampling (pi)", "pi", 100, 20, 2.0], ["R:sampling (1 sample)", "samples", 100, 20, 8.0], ["NumPy tree (1 sample)", "samples", 100, 20, 4.3403], ["DP forward", "Z", 100, 50, 1.7366], ["NumPy tree", "Z", 100, 50, 13.5847], ["PyTorch FFT", "Z", 100, 50, 2.9396], ["Fwd-bwd DP", "pi", 100, 50, 17.077], ["NumPy tree", "pi", 100, 50, 13.7635], ["PyTorch FFT + autograd", "pi", 100, 50, 7.3335], ["N\u00d7DP loo", "pi", 100, 50, 168.758], ["N\u00d7Tree loo", "pi", 100, 50, 1369.0549], ["R:sampling (pi)", "pi", 100, 50, 4.0], ["R:sampling (1 sample)", "samples", 100, 50, 19.0], ["NumPy tree (1 sample)", "samples", 100, 50, 8.1949], ["DP forward", "Z", 200, 5, 0.5664], ["NumPy tree", "Z", 200, 5, 30.8041], ["PyTorch FFT", "Z", 200, 5, 3.4691], ["Fwd-bwd DP", "pi", 200, 5, 10.6153], ["NumPy tree", "pi", 200, 5, 30.4528], ["PyTorch FFT + autograd", "pi", 200, 5, 10.7332], ["N\u00d7DP loo", "pi", 200, 5, 106.6668], ["N\u00d7Tree loo", "pi", 200, 5, 6597.9069], ["R:sampling (pi)", "pi", 200, 5, 1.5], ["R:sampling (1 sample)", "samples", 200, 5, 9.0], ["NumPy tree (1 sample)", "samples", 200, 5, 1.8647], ["DP forward", "Z", 200, 10, 1.0264], ["NumPy tree", "Z", 200, 10, 32.9313], ["PyTorch FFT", "Z", 200, 10, 4.8529], ["Fwd-bwd DP", "pi", 200, 10, 18.626], ["NumPy tree", "pi", 200, 10, 28.7993], ["PyTorch FFT + autograd", "pi", 200, 10, 8.6937], ["N\u00d7DP loo", "pi", 200, 10, 190.3885], ["N\u00d7Tree loo", "pi", 200, 10, 5775.5992], ["R:sampling (pi)", "pi", 200, 10, 2.0], ["R:sampling (1 sample)", "samples", 200, 10, 11.0], ["NumPy tree (1 sample)", "samples", 200, 10, 3.0279], ["DP forward", "Z", 200, 20, 2.0429], ["NumPy tree", "Z", 200, 20, 32.276], ["PyTorch FFT", "Z", 200, 20, 4.124], ["Fwd-bwd DP", "pi", 200, 20, 28.4693], ["NumPy tree", "pi", 200, 20, 28.2967], ["PyTorch FFT + autograd", "pi", 200, 20, 10.1712], ["N\u00d7DP loo", "pi", 200, 20, 416.1641], ["N\u00d7Tree loo", "pi", 200, 20, 5945.1557], ["R:sampling (pi)", "pi", 200, 20, 4.0], ["R:sampling (1 sample)", "samples", 200, 20, 19.5], ["NumPy tree (1 sample)", "samples", 200, 20, 6.1813], ["DP forward", "Z", 200, 50, 5.2107], ["NumPy tree", "Z", 200, 50, 30.4849], ["PyTorch FFT", "Z", 200, 50, 4.6474], ["Fwd-bwd DP", "pi", 200, 50, 53.4832], ["NumPy tree", "pi", 200, 50, 30.524], ["PyTorch FFT + autograd", "pi", 200, 50, 13.2619], ["N\u00d7DP loo", "pi", 200, 50, 934.7538], ["N\u00d7Tree loo", "pi", 200, 50, 4938.8423], ["R:sampling (pi)", "pi", 200, 50, 8.0], ["R:sampling (1 sample)", "samples", 200, 50, 32.0], ["NumPy tree (1 sample)", "samples", 200, 50, 9.6804], ["DP forward", "Z", 200, 100, 6.3158], ["NumPy tree", "Z", 200, 100, 25.3377], ["PyTorch FFT", "Z", 200, 100, 4.1153], ["Fwd-bwd DP", "pi", 200, 100, 57.3287], ["NumPy tree", "pi", 200, 100, 24.8501], ["PyTorch FFT + autograd", "pi", 200, 100, 11.6969], ["N\u00d7DP loo", "pi", 200, 100, 1328.7874], ["N\u00d7Tree loo", "pi", 200, 100, 4965.964], ["R:sampling (pi)", "pi", 200, 100, 16.0], ["R:sampling (1 sample)", "samples", 200, 100, 64.0], ["NumPy tree (1 sample)", "samples", 200, 100, 15.4969], ["DP forward", "Z", 500, 5, 1.2172], ["NumPy tree", "Z", 500, 5, 51.8853], ["PyTorch FFT", "Z", 500, 5, 5.4951], ["Fwd-bwd DP", "pi", 500, 5, 23.7639], ["NumPy tree", "pi", 500, 5, 52.434], ["PyTorch FFT + autograd", "pi", 500, 5, 17.82], ["N\u00d7DP loo", "pi", 500, 5, 555.3589], ["N\u00d7Tree loo", "pi", 500, 5, 29641.4172], ["R:sampling (pi)", "pi", 500, 5, 3.0], ["R:sampling (1 sample)", "samples", 500, 5, 16.0], ["NumPy tree (1 sample)", "samples", 500, 5, 1.8915], ["DP forward", "Z", 500, 10, 2.7249], ["NumPy tree", "Z", 500, 10, 58.103], ["PyTorch FFT", "Z", 500, 10, 7.7842], ["Fwd-bwd DP", "pi", 500, 10, 41.368], ["NumPy tree", "pi", 500, 10, 57.8723], ["PyTorch FFT + autograd", "pi", 500, 10, 16.4717], ["N\u00d7DP loo", "pi", 500, 10, 1264.4092], ["N\u00d7Tree loo", "pi", 500, 10, 27906.8019], ["R:sampling (pi)", "pi", 500, 10, 7.0], ["R:sampling (1 sample)", "samples", 500, 10, 29.5], ["NumPy tree (1 sample)", "samples", 500, 10, 3.3475], ["DP forward", "Z", 500, 20, 5.1172], ["NumPy tree", "Z", 500, 20, 61.4729], ["PyTorch FFT", "Z", 500, 20, 7.0051], ["Fwd-bwd DP", "pi", 500, 20, 70.8986], ["NumPy tree", "pi", 500, 20, 62.9375], ["PyTorch FFT + autograd", "pi", 500, 20, 17.6556], ["N\u00d7DP loo", "pi", 500, 20, 2416.2072], ["N\u00d7Tree loo", "pi", 500, 20, 29223.8581], ["R:sampling (pi)", "pi", 500, 20, 11.5], ["R:sampling (1 sample)", "samples", 500, 20, 47.0], ["NumPy tree (1 sample)", "samples", 500, 20, 6.3159], ["DP forward", "Z", 500, 50, 12.3354], ["NumPy tree", "Z", 500, 50, 53.8591], ["PyTorch FFT", "Z", 500, 50, 7.4879], ["Fwd-bwd DP", "pi", 500, 50, 147.2442], ["NumPy tree", "pi", 500, 50, 62.775], ["PyTorch FFT + autograd", "pi", 500, 50, 23.6032], ["N\u00d7DP loo", "pi", 500, 50, 5198.1777], ["N\u00d7Tree loo", "pi", 500, 50, 24681.2468], ["R:sampling (pi)", "pi", 500, 50, 20.0], ["R:sampling (1 sample)", "samples", 500, 50, 85.0], ["NumPy tree (1 sample)", "samples", 500, 50, 10.9989], ["DP forward", "Z", 500, 100, 18.2189], ["NumPy tree", "Z", 500, 100, 47.0037], ["PyTorch FFT", "Z", 500, 100, 5.0481], ["Fwd-bwd DP", "pi", 500, 100, 201.3546], ["NumPy tree", "pi", 500, 100, 48.2415], ["PyTorch FFT + autograd", "pi", 500, 100, 15.2904], ["N\u00d7DP loo", "pi", 500, 100, 9869.8554], ["N\u00d7Tree loo", "pi", 500, 100, 27552.974], ["R:sampling (pi)", "pi", 500, 100, 37.5], ["R:sampling (1 sample)", "samples", 500, 100, 119.5], ["NumPy tree (1 sample)", "samples", 500, 100, 19.9304], ["DP forward", "Z", 500, 200, 33.9792], ["NumPy tree", "Z", 500, 200, 48.4101], ["PyTorch FFT", "Z", 500, 200, 5.7151], ["Fwd-bwd DP", "pi", 500, 200, 331.1777], ["NumPy tree", "pi", 500, 200, 53.4483], ["PyTorch FFT + autograd", "pi", 500, 200, 18.0678], ["R:sampling (pi)", "pi", 500, 200, 72.0], ["R:sampling (1 sample)", "samples", 500, 200, 228.0], ["NumPy tree (1 sample)", "samples", 500, 200, 35.3704], ["DP forward", "Z", 500, 400, 53.1277], ["NumPy tree", "Z", 500, 400, 46.3899], ["PyTorch FFT", "Z", 500, 400, 4.9859], ["Fwd-bwd DP", "pi", 500, 400, 216.4979], ["NumPy tree", "pi", 500, 400, 47.1773], ["PyTorch FFT + autograd", "pi", 500, 400, 15.4898], ["R:sampling (pi)", "pi", 500, 400, 113.0], ["NumPy tree (1 sample)", "samples", 500, 400, 56.1459], ["DP forward", "Z", 1000, 5, 2.3385], ["NumPy tree", "Z", 1000, 5, 108.6994], ["PyTorch FFT", "Z", 1000, 5, 9.211], ["Fwd-bwd DP", "pi", 1000, 5, 44.7448], ["NumPy tree", "pi", 1000, 5, 103.3823], ["PyTorch FFT + autograd", "pi", 1000, 5, 22.8735], ["R:sampling (pi)", "pi", 1000, 5, 7.0], ["R:sampling (1 sample)", "samples", 1000, 5, 28.0], ["NumPy tree (1 sample)", "samples", 1000, 5, 2.5271], ["DP forward", "Z", 1000, 10, 4.8055], ["NumPy tree", "Z", 1000, 10, 112.7529], ["PyTorch FFT", "Z", 1000, 10, 9.7264], ["Fwd-bwd DP", "pi", 1000, 10, 69.649], ["NumPy tree", "pi", 1000, 10, 103.0896], ["PyTorch FFT + autograd", "pi", 1000, 10, 23.8904], ["R:sampling (pi)", "pi", 1000, 10, 10.0], ["R:sampling (1 sample)", "samples", 1000, 10, 39.0], ["NumPy tree (1 sample)", "samples", 1000, 10, 4.5994], ["DP forward", "Z", 1000, 20, 8.614], ["NumPy tree", "Z", 1000, 20, 112.7427], ["PyTorch FFT", "Z", 1000, 20, 9.0591], ["Fwd-bwd DP", "pi", 1000, 20, 117.6431], ["NumPy tree", "pi", 1000, 20, 106.9343], ["PyTorch FFT + autograd", "pi", 1000, 20, 27.0591], ["R:sampling (pi)", "pi", 1000, 20, 19.0], ["R:sampling (1 sample)", "samples", 1000, 20, 67.0], ["NumPy tree (1 sample)", "samples", 1000, 20, 6.6255], ["DP forward", "Z", 1000, 50, 20.3784], ["NumPy tree", "Z", 1000, 50, 107.5163], ["PyTorch FFT", "Z", 1000, 50, 8.8165], ["Fwd-bwd DP", "pi", 1000, 50, 272.44], ["NumPy tree", "pi", 1000, 50, 110.506], ["PyTorch FFT + autograd", "pi", 1000, 50, 24.4111], ["R:sampling (pi)", "pi", 1000, 50, 42.5], ["R:sampling (1 sample)", "samples", 1000, 50, 135.0], ["NumPy tree (1 sample)", "samples", 1000, 50, 17.8494], ["DP forward", "Z", 1000, 100, 39.5532], ["NumPy tree", "Z", 1000, 100, 103.9803], ["PyTorch FFT", "Z", 1000, 100, 9.3184], ["Fwd-bwd DP", "pi", 1000, 100, 474.2954], ["NumPy tree", "pi", 1000, 100, 110.206], ["PyTorch FFT + autograd", "pi", 1000, 100, 28.4767], ["R:sampling (pi)", "pi", 1000, 100, 79.5], ["R:sampling (1 sample)", "samples", 1000, 100, 260.0], ["NumPy tree (1 sample)", "samples", 1000, 100, 29.8912], ["DP forward", "Z", 1000, 200, 91.5389], ["NumPy tree", "Z", 1000, 200, 121.5408], ["PyTorch FFT", "Z", 1000, 200, 10.5316], ["Fwd-bwd DP", "pi", 1000, 200, 871.6261], ["NumPy tree", "pi", 1000, 200, 115.9055], ["PyTorch FFT + autograd", "pi", 1000, 200, 25.2559], ["R:sampling (pi)", "pi", 1000, 200, 129.5], ["R:sampling (1 sample)", "samples", 1000, 200, 510.0], ["NumPy tree (1 sample)", "samples", 1000, 200, 46.2915], ["DP forward", "Z", 1000, 400, 143.1514], ["NumPy tree", "Z", 1000, 400, 114.0728], ["PyTorch FFT", "Z", 1000, 400, 9.6598], ["Fwd-bwd DP", "pi", 1000, 400, 1293.889], ["NumPy tree", "pi", 1000, 400, 115.5037], ["PyTorch FFT + autograd", "pi", 1000, 400, 25.9126], ["R:sampling (pi)", "pi", 1000, 400, 247.5], ["R:sampling (1 sample)", "samples", 1000, 400, 841.5], ["NumPy tree (1 sample)", "samples", 1000, 400, 78.4869]];
